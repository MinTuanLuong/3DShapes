...
def show():
    ...
    geogebra_url = "https://www.geogebra.org/m/pa9z37sg"
    ...
    geogebra_url1 = "https://www.geogebra.org/m/zaphpw9a"
    if st.button("Tìm hiểu các công thức của Hình nón trên Geogebra"):
        st.write("Bấm vào nút bên dưới để mở trong tab mới.")
        st.markdown(f'<a href="{geogebra_url1}" target="_blank"><button>Geogebra - Hình nón</button></a>', unsafe_allow_html=True)
